...
<body>
	<section>
        <form action=" {{ url('restaurants') }} " method="post">
            ...
            時機：<input type="text" name="timming" class="form-control">(ex. 午餐,晚餐)<br>
            <input type="hidden" name="is_alive" class="form-control" value="1">
            價格：<input type="text" name="price" class="form-control">(1=低(0~150);2=中(150~300);3=高(300 up))<br>
            位置：<input type="text" name="location" class="form-control">(1=近(0~15分鐘);2=中(15~30分鐘);3=高(30分鐘 up))<br>
